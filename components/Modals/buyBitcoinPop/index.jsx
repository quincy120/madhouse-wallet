        ...
        <Modal.Body className={`position-relative rounded`}>
          ...
          <div className="content p-3">
            ...
            <div className="py-2">
              <Form>
                <div
                  className="d-flex align-items-start gap-10 flex-wrap justify-content-between"
                  style={{ fontSize: 12, lineHeight: "16px" }}
                >
                  <div className="d-flex align-items-center gap-10 flex-wrap py-2">
